			...
			<div class="col-md-6">
				<div class="row martopinput">
					<form action="{{route('city-store')}}" method="post">
						{{ csrf_field() }}
						<div class="col-sm-8">
							<input type="text" class="form-control" id="name" name="name" placeholder="Shto nje qytet ..."/>
						</div>
						<div class="col-sm-4">
		...
		<div class="col-md-12">
		    ...
		    <tbody>
		      @foreach($cities as $city)
						<tr>
			        <td>{{$city->name}}</td>
							<td><a href="{{route('city-edit',$city->id)}}" class="btn btn-primary btn-sm">Edit</a></td>
              <td>
