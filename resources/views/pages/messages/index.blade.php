                ...
                <div class="tab-pane fade in active" id="home">
                    <div class="list-group">
                        @foreach ($messages as $message)
                          <a href="{{route('view-message',$message->id)}}" class="list-group-item">
                              <div class="checkbox">
                                  <label>
                                      <input type="checkbox">
                                  </label>
                              ...
                              <span class="glyphicon glyphicon-star-empty"></span><span class="name" style="min-width: 120px;
                                  display: inline-block;">{{$message->from}}</span> <span class="">{{$message->title}}</span>
                              <span class="text-muted" style="font-size: 11px;"> {{$message->body}}</span> <span
