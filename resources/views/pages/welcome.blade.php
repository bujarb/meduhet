      ...
      <section class="col-xs-12 col-sm-6 col-md-12 section">
              ...
              <article class="search-result row">
                      ...
                      <li><i class="glyphicon glyphicon-time"></i> <span><strong>Data:</strong>{{$product->created_at->format('M d Y')}}</span></li>
            					<li><i class="glyphicon glyphicon-time"></i> <span><strong>Nga:</strong> <a href="{{route('view-user-profile',$product->user_id)}}">{{$product->user()->pluck('firstname')->first()}}</a></span></li>
